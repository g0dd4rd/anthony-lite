...
from commands.input import _handle_dialog_after_shortcut, _send_key_via_mcp
...
def _get_focused_app_key():
    ...
    try:
        ...
        log_and_print(f"[SHORTCUTS] Error getting focused app: {e}", level="error")
        return None, None
...
@step(
    ...
    "go to next tab",
    category="shortcuts",
    help_text="Switch to the next tab",
)
...
@step(
    ...
    "go to previous tab",
    category="shortcuts",
    help_text="Switch to the previous tab",
)
def handle_previous_tab(context):
    return _execute_app_action("Previous tab")


@step("new tab", "open a new tab", "open new tab", category="shortcuts", help_text="Open a new tab")
...
@step(
    ...
    "close this tab",
    category="shortcuts",
    help_text="Close the current tab",
)
...
@step("select all", category="shortcuts", help_text="Select all content")
def handle_select_all(context):
    return _execute_app_action("Select all")


@step("copy", "copy that", category="shortcuts", help_text="Copy selection")
def handle_copy(context):
    return _execute_app_action("Copy")


@step("paste", "paste that", category="shortcuts", help_text="Paste clipboard")
def handle_paste(context):
    return _execute_app_action("Paste")


@step("cut", "cut that", category="shortcuts", help_text="Cut selection")
def handle_cut(context):
    return _execute_app_action("Cut")


@step("undo", category="shortcuts", help_text="Undo the last action")
def handle_undo(context):
    return _execute_app_action("Undo")


@step("redo", category="shortcuts", help_text="Redo the last undone action")
...
@step("find", "find in page", "search in page", category="shortcuts", help_text="Open find/search")
...
@step("zoom in", category="shortcuts", help_text="Zoom in")
def handle_zoom_in(context):
    return _execute_app_action("Zoom in")


@step("zoom out", category="shortcuts", help_text="Zoom out")
