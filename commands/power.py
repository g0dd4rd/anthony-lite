from commands import _listen, _mcp_client, _speak, step
...
def handle_suspend(context):
    return _confirm_and_execute("Are you sure you want to put the computer to sleep?", "suspend")
...
def handle_restart(context):
    return _confirm_and_execute("Are you sure you want to restart the computer?", "restart")
...
def handle_shutdown(context):
    return _confirm_and_execute("Are you sure you want to shut down the computer?", "shutdown")
