...
@step(
    ...
    "increase the volume",
    category="audio",
    help_text="Increase volume by 10%",
)
...
@step(
    ...
    "decrease the volume",
    category="audio",
    help_text="Decrease volume by 10%",
)
...
@step(
    "set volume to {level:d}",
    "volume {level:d}",
    "set volume to {level:d} percent",
    "volume {level:d} percent",
    category="audio",
    help_text="Set volume to a specific level (0-100)",
)
...
@step(
    ...
    "resume playback",
    category="audio",
    help_text="Play or resume media",
)
...
@step("pause", "pause music", "pause playback", category="audio", help_text="Pause media")
...
@step("play pause", "toggle playback", category="audio", help_text="Toggle play/pause")
...
@step("next", "next song", "next track", "skip", category="audio", help_text="Skip to next track")
...
@step(
    ...
    "go back",
    category="audio",
    help_text="Go to previous track",
)
...
@step(
    ...
    "silence this tab",
    category="audio",
    help_text="Mute the current browser tab",
)
...
@step(
    ...
    "unmute this tab",
    category="audio",
    help_text="Unmute the current browser tab",
)
