...
@step('turn on {setting}', 'enable {setting}', 'activate {setting}', 'switch on {setting}',
      category='settings', help_text='Enable a system setting (dark mode, wifi, bluetooth, etc.)')
...
@step('turn off {setting}', 'disable {setting}', 'deactivate {setting}', 'switch off {setting}',
      category='settings', help_text='Disable a system setting')
...
@step('set wallpaper to {value}', 'set wallpaper {value}',
      'change wallpaper to {value}', 'change wallpaper {value}',
      category='settings', help_text='Set the desktop wallpaper')
