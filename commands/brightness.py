...
@step(
    ...
    "brighter",
    category="brightness",
    help_text="Increase screen brightness",
)
...
@step(
    ...
    "dim",
    category="brightness",
    help_text="Decrease screen brightness",
)
...
@step(
    ...
    "full brightness",
    category="brightness",
    help_text="Set brightness to maximum",
)
def handle_brightness_max(context):
    return _mcp_client.call_tool("set_brightness", {"target": "screen", "level": "max"})


@step("min brightness", category="brightness", help_text="Set brightness to minimum")
...
@step(
    ...
    "brightness {level}",
    category="brightness",
    help_text="Set brightness to a percentage (e.g., 50%)",
)
...
@step(
    ...
    category="brightness",
    help_text="Increase keyboard backlight",
)
...
@step(
    ...
    category="brightness",
    help_text="Decrease keyboard backlight",
)
...
@step(
    ...
    category="brightness",
    help_text="Turn off keyboard backlight",
)
...
@step(
    ...
    "get power profile",
    category="brightness",
    help_text="Check current power profile",
)
...
@step(
    "set power mode to {profile}",
    "power mode {profile}",
    "set power profile to {profile}",
    category="brightness",
    help_text="Set power profile (performance, balanced, power-saver)",
)
