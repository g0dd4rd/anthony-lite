...
class DialogHandler:
    ...
    def detect_save_dialog(self, app_name: str = None, timeout: float = 2.0) -> dict | None:
        """
    ...
    def activate_button_by_keyboard(
        self, dialog_data: dict, button_choice: str, use_fallback: bool = True, key_callback=None
    ) -> bool:
        """
